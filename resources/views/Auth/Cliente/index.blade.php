    ...
    <div class="w-80 bg-white shadow rounded">
        <div class="h-48 w-full bg-gray-200 flex flex-col justify-between p-4 bg-cover bg-center"
            ...
            <div class="flex justify-between"> <input type="checkbox" /> <button class="text-white hover:text-blue-500">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 10 10"
                        stroke="currentColor">
        ...
        <div class="p-4 flex flex-col items-center">
            ...
            <div class="flex justify-between w-full mt-4">
                <div class="flex items-center text-gray-500"> <input id="input1" type="checkbox" class="mr-2" />
                    <label for="input1" class="select-none cursor-pointer">Compare</label> </div>
                <div> <button
                        ...
                        Add to List <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-2" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
