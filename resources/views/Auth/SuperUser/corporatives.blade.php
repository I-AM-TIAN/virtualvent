                                        ...
                                        @foreach ($corporativos as $corporativo)
                                            <tr class="hover:bg-gray-100">
                                                ...
                                                <td class="py-4 px-6 text-sm font-medium whitespace-nowrap">
                                                    <a href="#"
                                                        class="text-blue-600 dark:text-blue-500 hover:underline" data-modal-toggle="authentication-modal">Edit</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                        ...
                        <div class="relative w-full max-w-md px-4 h-full md:h-auto">
                            ...
                            <div class="bg-white rounded-lg shadow relative dark:bg-gray-700">
                                ...
                                <form class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="#">
                                    <h3 class="text-xl font-medium text-gray-900 dark:text-white">Modificar usuario corporativo</h3>
                                    <div>
                                        <label for="email"
                                            class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Your
                                            email</label>
